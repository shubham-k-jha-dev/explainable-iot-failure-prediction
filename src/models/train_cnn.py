...
plt.plot(
    fpr,
    tpr,
    label=f"1D-CNN ROC-AUC = {roc_auc:.4f}"
)
...
print("- models/cnn_test_probabilities.joblib")
print("- reports/cnn_metrics.csv")
print("- reports/cnn_loss_curve.png")
print("- reports/cnn_confusion_matrix.png")
print("- reports/cnn_roc_curve.png")
