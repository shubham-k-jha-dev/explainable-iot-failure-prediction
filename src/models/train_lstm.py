...
X_val_tensor = torch.tensor(X_val).unsqueeze(2)
...
print("\nSaved:")
print("- models/lstm_model.pth")
print("- models/lstm_test_probabilities.joblib")
print("- reports/lstm_metrics.csv")
print("- reports/lstm_loss_curve.png")
print("- reports/lstm_confusion_matrix.png")
print("- reports/lstm_roc_curve.png")
